...
import { Shield, LogOut, User, ChevronDown, Menu, X } from 'lucide-react'
    ...
    <header className="bg-pmmg-green-800 shadow-lg sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-white font-bold text-sm hidden sm:block">3ª CIA PM MAmb</span>
        ...
        <div className="hidden md:flex items-center gap-2 relative">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-pmmg-green-300 text-xs leading-tight">{PERFIL_LABEL[usuario.perfil]}</p>
            </div>
          ...
          {menuOpen && (
            <div className="absolute top-full right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
              <div className="px-3 py-2 border-b border-gray-100">
                <p className="text-xs text-gray-500">Matrícula: {usuario.matricula}</p>
        ...
        <div className="md:hidden bg-pmmg-green-900 border-t border-pmmg-green-700 px-4 py-3">
          <div className="flex items-center gap-3 mb-3 pb-3 border-b border-pmmg-green-700">
            ...
            <div>
              ...
              <p className="text-pmmg-green-300 text-xs">{PERFIL_LABEL[usuario.perfil]} · {usuario.matricula}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
